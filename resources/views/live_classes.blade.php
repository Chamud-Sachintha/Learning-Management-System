...
<body style="overflow-x: hidden;">
    ...
    <h1 class="heading ms-3">LIVE CLASSES</h1>
        ...
        <div class="row ms-2">
            ...
            <div class="col-6" style="position: absolute;">
                <div class="ratio ratio-16x9" style="width: 100%; left: 106%;" id="myVedio" style="position:absolute;">
                    <iframe src="https://www.youtube.com/embed/MPq6vYm3Nno" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="position:absolute;top:-43px;left:0;width:100%;height:100%;" title="Build an E-commerce website with Laravel and PayHere - Implement checkout form"></iframe>
                        <!-- <iframe width="640" height="360" frameborder="0" src="https://mega.nz/embed/U8UiETqB#C1bg_tDdO2aZXwb2J3_xT6_qYAEYuhcLkPNQMtZ3J_I" allowfullscreen ></iframe> -->
